...
public class DeviceContext implements Serializable {
    ...
    public DeviceContext(String deviceId, Timestamp lastPing, byte[] certificate, Timestamp certExpTime) {
    ...
    public boolean isAttested() {
        ...
        return new Timestamp(this.certExpTime.getTime()).before(now);
    }
