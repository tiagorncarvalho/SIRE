...
public class DummyAttester {
	...
	public static void main(String[] args) throws SireException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException {
		...
		ECPoint verifierPublicKey = proxy.getVerifierPublicKey();
		...
		try {
			...
			Message1 message1 = proxy.processMessage0(attesterId, message0);
			...
			Message3 message3 = proxy.processMessage2(attesterId, message2);
